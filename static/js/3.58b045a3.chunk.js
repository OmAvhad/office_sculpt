    ...
    [3],
    {
        60: function (t, e, n) {
            ...
            var i,
                ...
                y = function (t, e) {
                    var n,
                        ...
                        r = c("paint", function (t) {
                            "first-contentful-paint" === t.name && (r && r.disconnect(), t.startTime < i.timeStamp && ((a.value = t.startTime), a.entries.push(t), p.add(a), n()));
                        });
                    r &&
                        ((n = m(t, a, e)),
                        d(function (i) {
                ...
                E = new Date(),
                L = function (t, e) {
                    i || ((i = e), (a = t), (r = new Date()), F(removeEventListener), T());
                },
                T = function () {
                    if (a >= 0 && a < r - E) {
                ...
                k = function (t, e) {
                    var n,
                        ...
                        s = u("FID"),
                        v = function (t) {
                            t.startTime < r.timeStamp && ((s.value = t.processingStart - t.startTime), s.entries.push(t), p.add(s), n());
                        },
                        l = c("first-input", v);
                    (n = m(t, s, e)),
                        l &&
                        ...
                        l &&
                            d(function () {
                                var r;
                                (s = u("FID")), (n = m(t, s, e)), (o = []), (a = -1), (i = null), F(addEventListener), (r = v), o.push(r), T();
                            });
                },
                C = function (t, e) {
                    var n,
